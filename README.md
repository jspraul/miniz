...
static __forceinline is giving it fits, so I'm changing all usage of 
...
MINIZ_NO_ZLIB_COMPATIBLE_NAMESmacro, allowing miniz.c to be mixed with zlib in the same compilation unit.
